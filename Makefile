...
SOURCES       = src/SailfishAuth.cpp \
		src/account.cpp \
		src/oauth.cpp \
		src/accountmodel.cpp moc/moc_account.cpp \
		moc/moc_accountmodel.cpp
OBJECTS       = obj/SailfishAuth.o \
		obj/account.o \
		obj/oauth.o \
		obj/accountmodel.o \
		obj/moc_account.o \
...
Makefile: SailfishAuth.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d obj/SailfishAuth1.0.0 || mkdir -p obj/SailfishAuth1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/SailfishAuth1.0.0/ && $(COPY_FILE) --parents src/account.h src/oauth.h src/accountmodel.h obj/SailfishAuth1.0.0/ && $(COPY_FILE) --parents src/SailfishAuth.cpp src/account.cpp src/oauth.cpp src/accountmodel.cpp obj/SailfishAuth1.0.0/ && (cd `dirname obj/SailfishAuth1.0.0` && $(TAR) SailfishAuth1.0.0.tar SailfishAuth1.0.0 && $(COMPRESS) SailfishAuth1.0.0.tar) && $(MOVE) `dirname obj/SailfishAuth1.0.0`/SailfishAuth1.0.0.tar.gz . && $(DEL_FILE) -r obj/SailfishAuth1.0.0
...
compiler_moc_header_make_all: moc/moc_account.cpp moc/moc_accountmodel.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc/moc_account.cpp moc/moc_accountmodel.cpp
moc/moc_account.cpp: /usr/include/qt5/QtCore/QObject \
		...
		src/account.h
	/usr/lib/qt5/bin/moc $(DEFINES) $(INCPATH) -I/usr/lib/gcc/i486-meego-linux/4.6.4/../../../../include/c++/4.6.4 -I/usr/lib/gcc/i486-meego-linux/4.6.4/../../../../include/c++/4.6.4/i486-meego-linux -I/usr/lib/gcc/i486-meego-linux/4.6.4/../../../../include/c++/4.6.4/backward -I/usr/lib/gcc/i486-meego-linux/4.6.4/include -I/usr/local/include -I/usr/include src/account.h -o moc/moc_account.cpp

moc/moc_accountmodel.cpp: /usr/include/qt5/QtCore/QAbstractListModel \
		...
		src/accountmodel.h
	/usr/lib/qt5/bin/moc $(DEFINES) $(INCPATH) -I/usr/lib/gcc/i486-meego-linux/4.6.4/../../../../include/c++/4.6.4 -I/usr/lib/gcc/i486-meego-linux/4.6.4/../../../../include/c++/4.6.4/i486-meego-linux -I/usr/lib/gcc/i486-meego-linux/4.6.4/../../../../include/c++/4.6.4/backward -I/usr/lib/gcc/i486-meego-linux/4.6.4/include -I/usr/local/include -I/usr/include src/accountmodel.h -o moc/moc_accountmodel.cpp
...
obj/SailfishAuth.o: src/SailfishAuth.cpp /usr/include/qt5/QtQuick/QtQuick \
		...
		src/oauth.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/SailfishAuth.o src/SailfishAuth.cpp

obj/account.o: src/account.cpp src/account.h \
		/usr/include/qt5/QtCore/QObject \
		/usr/include/qt5/QtCore/qobject.h \
		/usr/include/qt5/QtCore/qobjectdefs.h \
		/usr/include/qt5/QtCore/qnamespace.h \
		...
		/usr/include/qt5/QtCore/qset.h \
		/usr/include/qt5/QtCore/qcontiguouscache.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/account.o src/account.cpp

obj/oauth.o: src/oauth.cpp src/oauth.h \
		/usr/include/qt5/QtCore/QObject \
		/usr/include/qt5/QtCore/qobject.h \
		/usr/include/qt5/QtCore/qobjectdefs.h \
		/usr/include/qt5/QtCore/qnamespace.h \
		...
		/usr/include/qt5/QtCore/qcryptographichash.h \
		/usr/include/qt5/QtCore/qmath.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/oauth.o src/oauth.cpp
...
obj/moc_account.o: moc/moc_account.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/moc_account.o moc/moc_account.cpp
...
install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/SailfishAuth || mkdir -p $(INSTALL_ROOT)/usr/share/SailfishAuth
	-$(INSTALL_DIR) /home/mersdk/SailfishAuth27sty/SailfishAuth/qml $(INSTALL_ROOT)/usr/share/SailfishAuth/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/SailfishAuth/qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/SailfishAuth/ 


install_desktop: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/applications || mkdir -p $(INSTALL_ROOT)/usr/share/applications
	-$(INSTALL_PROGRAM) /home/mersdk/SailfishAuth27sty/SailfishAuth/SailfishAuth.desktop $(INSTALL_ROOT)/usr/share/applications/

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/SailfishAuth.desktop
...
install_icon: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/mersdk/SailfishAuth27sty/SailfishAuth/SailfishAuth.png $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps/

uninstall_icon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps/SailfishAuth.png
