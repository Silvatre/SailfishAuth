...
# Generated by qmake (3.0) (Qt 5.1.0) on: Thu Jan 16 06:09:37 2014
...
SOURCES       = src/SailfishAuth.cpp \
		src/account.cpp \
		src/oauth.cpp moc/moc_account.cpp
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/SailfishAuth1.0.0/ && $(COPY_FILE) --parents src/account.h src/oauth.h obj/SailfishAuth1.0.0/ && $(COPY_FILE) --parents src/SailfishAuth.cpp src/account.cpp src/oauth.cpp obj/SailfishAuth1.0.0/ && (cd `dirname obj/SailfishAuth1.0.0` && $(TAR) SailfishAuth1.0.0.tar SailfishAuth1.0.0 && $(COMPRESS) SailfishAuth1.0.0.tar) && $(MOVE) `dirname obj/SailfishAuth1.0.0`/SailfishAuth1.0.0.tar.gz . && $(DEL_FILE) -r obj/SailfishAuth1.0.0
...
compiler_moc_header_make_all: moc/moc_account.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc/moc_account.cpp
...
install_qml: first FORCE
	...
	-$(INSTALL_DIR) /home/mersdk/SailfishAuth/qml $(INSTALL_ROOT)/usr/share/SailfishAuth/
...
install_desktop: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/mersdk/SailfishAuth/SailfishAuth.desktop $(INSTALL_ROOT)/usr/share/applications/
...
install_icon: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/mersdk/SailfishAuth/SailfishAuth.png $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps/
