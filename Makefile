...
# Generated by qmake (3.0) (Qt 5.1.0) on: Sat Jan 11 21:07:26 2014
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/SailfishAuth1.0.0/ && $(COPY_FILE) --parents src/SailfishAuth.cpp obj/SailfishAuth1.0.0/ && (cd `dirname obj/SailfishAuth1.0.0` && $(TAR) SailfishAuth1.0.0.tar SailfishAuth1.0.0 && $(COMPRESS) SailfishAuth1.0.0.tar) && $(MOVE) `dirname obj/SailfishAuth1.0.0`/SailfishAuth1.0.0.tar.gz . && $(DEL_FILE) -r obj/SailfishAuth1.0.0
